...
/**
   ...
   (0, ..., 1, 0) in either 1D or using a multi-dimensional index. The elements
   are continguous in memory in the order of the 1D index.
*/
...
public:
  ...
  */
  ...
  /**
     ...
     traverses the container in the order (0, ..., 0), (0, ..., 1), ..., (0,
     ..., 1, 0), ....
  */
  ...
  */
  ...
  /**
     \return Iterator to end. Container is traverse in the order
     (0, ..., 0), (0, ..., 1), ..., (0, ..., 1, 0).
  */
