...
/** \class State1D PTOF/State.h "PTOF/State.h"
 ...
 - \c tag
 - \c info */
template <typename Info_t, typename Time_t = useful::Empty,
...
make_state(Foam::scalar position, Info info, Locator const &locator,
...
make_state(Foam::Vector2D<Foam::scalar> const &position, Info info,
           Locator const &locator, Time time = {}, Mass mass = {},
           Tag tag = {}) {
  Foam::label cell_id = locator(position);
  if (outside(cell_id))
    throw std::runtime_error{"Particle initialized outside mesh"};
...
make_state(Foam::vector const &position, Info info, Locator const &locator,
           Time time = {}, Mass mass = {}, Tag tag = {}) {
  Foam::label cell_id = locator(position);
  if (outside(cell_id))
    throw std::runtime_error{"Particle initialized outside mesh"};
...
template <typename Info, typename Time = useful::Empty,
          typename Mass = useful::Empty, typename Tag = useful::Empty>
State2D<Info, Time, Mass, Tag>
make_state(Foam::Vector2D<Foam::scalar> const &position, Foam::label cell_id,
           Time time = {}, Mass mass = {}, Tag tag = {}) {
  return {position, cell_id, time, mass, tag};
}
...
template <typename Info, typename Time = useful::Empty,
          typename Mass = useful::Empty, typename Tag = useful::Empty>
State3D<Info, Time, Mass, Tag> make_state(Foam::vector const &position,
                                          Foam::label cell_id, Time time = {},
                                          Mass mass = {}, Tag tag = {}) {
  return {position, cell_id, time, mass, tag};
}
...
along each basis direction. \details Defines:
- \c position
- \c periodicity
- \c cell
- \c time
...
make_state(Foam::scalar position, std::vector<int> periodicity, Info info,
           Locator const &locator, Time time = {}, Mass mass = {},
           Tag tag = {}) {
  Foam::label cell_id = locator(position);
  if (outside(cell_id))
...
make_state(Foam::Vector2D<Foam::scalar> const &position,
           std::vector<int> periodicity, Info info, Locator const &locator,
           Time time = {}, Mass mass = {}, Tag tag = {}) {
  Foam::label cell_id = locator(position);
  if (outside(cell_id))
    throw std::runtime_error{"Particle initialized outside mesh"};
...
make_state(Foam::vector const &position, std::vector<int> periodicity,
           Info info, Locator const &locator, Time time = {}, Mass mass = {},
           Tag tag = {}) {
  Foam::label cell_id = locator(position);
  if (outside(cell_id))
    throw std::runtime_error{"Particle initialized outside mesh"};
...
State1D_Periodic<Info, Time, Mass, Tag>
make_state(Foam::scalar position, std::vector<int> periodicity, Info info,
           Foam::label cell_id, Time time = {}, Mass mass = {}, Tag tag = {}) {
  return {position, periodicity, cell_id, time, mass, tag};
}
...
State2D_Periodic<Info, Time, Mass, Tag>
make_state(Foam::Vector2D<Foam::scalar> const &position,
           std::vector<int> periodicity, Foam::label cell_id, Time time = {},
           Mass mass = {}, Tag tag = {}) {
  return {position, periodicity, cell_id, time, mass, tag};
}
