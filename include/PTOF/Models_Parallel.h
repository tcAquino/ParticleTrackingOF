...
namespace ptof
{
  ...
  /** \namespace ptof::model_periodic_cartesian_advection_diffusion_surface_decay_2d_parallel
  ...
  namespace model_periodic_cartesian_advection_diffusion_surface_decay_2d_parallel
  {
    ...
    using model_periodic_cartesian_advection_diffusion_surface_decay_2d::InitialCondition;
  ...
  /** \namespace ptof::model_periodic_cartesian_advection_diffusion_surface_decay_3d_parallel
  ...
  namespace model_periodic_cartesian_advection_diffusion_surface_decay_3d_parallel
  {
    ...
    using model_periodic_cartesian_advection_diffusion_surface_decay_3d::InitialCondition;
  ...
  /** \namespace ptof::model_bcc_cartesian_advection_diffusion_surface_decay_parallel
  ...
  namespace model_bcc_symmetryplanes_advection_diffusion_surface_decay_parallel
  {
    ...
    using model_bcc_symmetryplanes_advection_diffusion_surface_decay::InitialCondition;
