...
namespace ptof
{
  ...
  struct Directories
  {
    ...
    /** Construct given base cases directory (default ../cases if empty string), case name,
  ...
  {
  private:
    std::string dir;              /**< \private OpenFOAM base cases directory.    */
    std::string time_name_input;  /**< \private Information about time directory. */
