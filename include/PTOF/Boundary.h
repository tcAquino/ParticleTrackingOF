...
namespace ptof
{
   ...
   *  \brief Keep track of names and types of boundary conditions .*/
   ...
   * followed by a boundary condition type. */
  ...
  /** \struct Boundary_Periodic_OF PTOF/Boundary.h "PTOF/Boundary.h"
   *  \brief Boundary object for periodic boundaries.
