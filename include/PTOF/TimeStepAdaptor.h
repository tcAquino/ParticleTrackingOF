...
/** \class TimeStepAdaptor_CellSize PTOF/TimeStepAdaptor.h
  "PTOF/TimeStepAdaptor.h" \brief Adaptive time step control based on local cell
  size. \details Takes reaction limitations to time step only if close to
  reactive boundary */
...
public:
  ...
  */
  TimeStepAdaptor_CellSize_SurfaceReaction(
      ...
      SolverParameters const &params_solvers, CheckOptions::NoCheck)
      : TimeStepAdaptor_CellSize_SurfaceReaction{
  ...
  */
  TimeStepAdaptor_CellSize_SurfaceReaction(
      ...
      TransportParameters const &params_transport,
      ReactionParameters const &params_reaction,
      SolverParameters const &params_solvers, CheckOptions::Check)
      : TimeStepAdaptor_CellSize_SurfaceReaction{
            geometry,         velocity_field,  surface_reaction,
            params_transport, params_reaction, params_solvers} {
  ...
  */
  TimeStepAdaptor_CellSize_SurfaceReaction(
      ...
      TransportParameters const &params_transport,
      ReactionParameters const &params_reaction,
      SolverParameters const &params_solvers, CheckOptions::Warn)
      : TimeStepAdaptor_CellSize_SurfaceReaction{
            geometry,         velocity_field,  surface_reaction,
            params_transport, params_reaction, params_solvers} {
  ...
  */
  TimeStepAdaptor_CellSize_SurfaceReaction(
      ...
      : _geometry{geometry}, _velocity_field{velocity_field},
        ...
        _params_transport{params_transport}, _params_reaction{params_reaction},
        _params_solvers{params_solvers}, _volume_factor{1.} {
  ...
  */
  ...
  double operator()(State &state, TimeGenerator &time_generator,
    ...
    double local_diffusion_time =
        cell_side * cell_side / (2. * _params_transport.diff_coeff);
    ...
    double local_reaction_time =
        _params_transport.diff_coeff / (reaction_rate * reaction_rate);

    double time_step = std::max(
        std::min({_params_solvers.local_time_step_adv * local_advection_time,
                  _params_solvers.local_time_step_diff * local_diffusion_time,
                  _params_solvers.local_time_step_react * local_reaction_time}),
        std::min({_params_solvers.global_time_step_adv *
                      _params_transport.advection_time,
                  _params_solvers.global_time_step_diff *
                      _params_transport.diffusion_time,
                  _params_solvers.global_time_step_react *
                      _params_reaction.reaction_time}));
...
TimeStepAdaptor_CellSize_SurfaceReaction(
    ...
    SolverParameters const &, CheckOptions::NoCheck)
    -> TimeStepAdaptor_CellSize_SurfaceReaction<
        Geometry, VelocityField, SurfaceReaction, TransportParameters,
        ReactionParameters, SolverParameters, CheckOptions::NoCheck>;
template <typename Geometry, typename VelocityField, typename SurfaceReaction,
          typename TransportParameters, typename ReactionParameters,
          typename SolverParameters>
TimeStepAdaptor_CellSize_SurfaceReaction(
    Geometry const &, VelocityField const &, SurfaceReaction &,
    TransportParameters const &, ReactionParameters const &,
    SolverParameters const &, CheckOptions::Check)
    -> TimeStepAdaptor_CellSize_SurfaceReaction<
        Geometry, VelocityField, SurfaceReaction, TransportParameters,
        ReactionParameters, SolverParameters, CheckOptions::Check>;
template <typename Geometry, typename VelocityField, typename SurfaceReaction,
          typename TransportParameters, typename ReactionParameters,
          typename SolverParameters>
TimeStepAdaptor_CellSize_SurfaceReaction(
    Geometry const &, VelocityField const &, SurfaceReaction &,
    TransportParameters const &, ReactionParameters const &,
    SolverParameters const &, CheckOptions::Warn)
    -> TimeStepAdaptor_CellSize_SurfaceReaction<
        Geometry, VelocityField, SurfaceReaction, TransportParameters,
        ReactionParameters, SolverParameters, CheckOptions::Warn>;
} // namespace ptof
