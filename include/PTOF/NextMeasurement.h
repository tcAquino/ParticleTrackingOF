...
/** \struct NextMeasurementTime PTOF/NextMeasurement.h "PTOF/NextMeasurement.h"
   *  \brief Polymorphic object to handle setting up the next measurement
...
/** \struct NextMeasurementTime_step PTOF/Output_Cases.h "PTOF/Output_Cases.h"
 *  \brief NextMeasurementTime object for constant time step. */
template <typename Parameters>
struct NextMeasurementTime_step final : NextMeasurementTime<Parameters> {
  NextMeasurementTime_step(Parameters const &parameters)
...
/** \struct NextMeasurementTime_linear PTOF/Output_Cases.h
  "PTOF/Output_Cases.h" \brief NextMeasurementTime object for linearly-spaced
  times. */
template <typename Parameters>
...
/** \struct Output_Cases::NextMeasurementTime_log PTOF/Output_Cases.h
  "PTOF/Output_Cases.h" \brief NextMeasurementTime object for log-spaced
  times. */
template <typename Parameters>
