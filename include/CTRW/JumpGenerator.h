/**
 * @file   JumpGenerator.h
 * @author Tomás Aquino <tomas.aquino@csic.es>
 * @date   Sat Jan 20 00:00:00 2018
 *
 * @brief Objects to generate (generalized) position increments for CTRW.
 *
 * @details A \c JumpGenerator should implement the following functionality:
 *
 * @code{.cpp}
 * class JumpGenerator {
 * public:
 ...
 *   // Return the jump increment with type of state element to be incremented.
 *   }
 * };
 * @endcode
 */
 ...
 *
 * @note Particle state must define:
 *
 * - \c position
 */
...
/**
 * @brief Jump according to a velocity field and time step, using Heun scheme.
 * @details Boundary conditions are enforced in predictor-corrector steps.
 *
 * @note Particle state must define:
 *
