...
namespace ctrw
{
  ...
  public:
    ...
    auto const& get_jump_generator_1() const
    { return jump_generator_1; }
   ...
   * \brief Diffusion jumps along each dimension
   ...
   * \brief One-dimensional random walk jumps with fixed step sizes
  // to left or right. */
   ...
   * \brief Random walk jumps along current orientation
   ...
   * \brief Gaussian-distributed angle jumps
