 ...
 * "CTRW/StateGetter.h" \brief Get absolute position given state from position
 * and periodicity \details state.periodicity should hold the (directional)
 * integer number of times unit cell has been traversed. \note Direction vector
 * is normalized upon construction. */
 ...
 * "CTRW/StateGetter.h" \brief Get component of absolute position given state
 * from position and periodicity \details state.periodicity should hold the
 * (directional) integer number of times unit cell has been traversed. \tparam
 * dd Component to extract. \note Unit cell faces must be perpendicular to
...
/** \struct Get_position_periodic_cartesian_projection CTRW/StateGetter.h
 "CTRW/StateGetter.h" \brief Get projection of absolute position along given
 direction, given state from position and periodicity \details state.periodicity
 should hold the (directional) integer number of times unit cell has been
 traversed. \note
