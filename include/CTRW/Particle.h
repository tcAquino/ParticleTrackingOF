...
namespace ctrw
{
  /** \class Particle CTRW/Particle.h "CTRW/Particle.h"
   ...
   \tparam State_t Object holding particle state information.
  */
  ...
  public:
    ...
    */
    ...
    , _state_old{ state_old }
    {}

    /** \param transition Update particle states according to this object that modifies a state.*/
    ...
    /** \param transformation Transformation to apply to both new and old state individually.*/
    ...
    /** \param transformation Transformation to apply to both states simultaneously.*/
    template <typename Transformation>
