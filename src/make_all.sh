...
./make.sh advection_diffusion_decay_2d
...
./make.sh periodic_cartesian_advection_diffusion_decay_2d
...
./make.sh advection_diffusion_decay_3d
...
./make.sh periodic_cartesian_advection_diffusion_decay_3d
...
./make.sh bcc_cartesian_advection_diffusion_decay
...
./make.sh bcc_symmetryplanes_advection_diffusion_decay
