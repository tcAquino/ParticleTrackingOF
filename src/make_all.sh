...
NC='\033[0m'
err=0
./make.sh advection_diffusion_2d
((err+=$?))
...
((err+=$?))
./make.sh periodic_cartesian_advection_diffusion_2d
((err+=$?))
...
((err+=$?))
./make.sh advection_diffusion_3d
((err+=$?))
...
((err+=$?))
./make.sh periodic_cartesian_advection_diffusion_3d
((err+=$?))
