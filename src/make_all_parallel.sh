...
((err+=$?))
./make_parallel.sh advection_diffusion_surface_decay_2d
((err+=$?))
...
((err+=$?))
./make_parallel.sh periodic_cartesian_advection_diffusion_surface_decay_2d
((err+=$?))
...
((err+=$?))
./make_parallel.sh advection_diffusion_surface_decay_3d
((err+=$?))
...
((err+=$?))
./make_parallel.sh periodic_cartesian_advection_diffusion_surface_decay_3d
((err+=$?))
...
((err+=$?))
./make_parallel.sh bcc_cartesian_advection_diffusion_surface_decay
((err+=$?))
...
((err+=$?))
./make_parallel.sh bcc_symmetryplanes_advection_diffusion_surface_decay
((err+=$?))
